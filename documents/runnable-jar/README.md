...
```bash
curl -LO https://repo1.maven.org/maven2/org/openjproxy/ojp-server/1.0.0-RC1/ojp-server-1.0.0-RC2-RC1-shaded.jar
```
...
java -Duser.timezone=UTC -Dojp.libs.path=./ojp-libs -jar ojp-server-1.0.0-RC2-RC1-shaded.jar
```
...
```bash
java -Duser.timezone=UTC -Dojp.libs.path=/opt/drivers -jar ojp-server-1.0.0-RC2-RC1-shaded.jar
```
...
java -Duser.timezone=UTC \
     ...
     -jar ojp-server-1.0.0-RC2-RC1-shaded.jar
```
...
```bash
nohup java -Duser.timezone=UTC -jar ojp-server-1.0.0-RC2-RC1-shaded.jar > ojp-server.log 2>&1 &
```
...
```bash
java -Duser.timezone=UTC -Xmx2g -jar ojp-server-1.0.0-RC2-RC1-shaded.jar
```
