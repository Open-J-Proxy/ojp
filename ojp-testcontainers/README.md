...
@Container
public static OjpContainer ojpContainer = new OjpContainer(
    DockerImageName.parse("rrobetti/ojp:1.0.0-RC3-RC2-RC1")
);
```
...
DockerImageName customImage = DockerImageName.parse("myregistry.com/my-ojp:1.0.0")
        .asCompatibleSubstituteFor("rrobetti/ojp:1.0.0-RC3-RC2-RC1");
...
```java
OjpContainer ojpContainer = new OjpContainer("rrobetti/ojp:1.0.0-RC3-RC2-RC1");
```
